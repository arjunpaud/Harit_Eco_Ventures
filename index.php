...
<main class="main">
    ...
    <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <div class="carousel-item active">
        ...
        <div class="carousel-container text-center">
          ...
          <p>We are officially registered as Harit Eco Ventures Pvt. Ltd. under the Company Act 2063 at the Office of the Company Registrar, Ministry of Trade, Commerce, and Supplies.
          </p>
        </div>
    ...
    <div class="container">
      <div class="row gy-4 justify-content-between align-items-center">
        <div class="col-lg-6 order-lg-2 position-relative" data-aos="zoom-out">
          ...
          <a href="https://www.youtube.com/watch?v=IsAg-JqJnA8" class="glightbox pulsating-play-btn">
            <span class="play"><i class="bi bi-play-fill"></i></span>
          </a>
        </div>
        <div class="col-lg-5 order-lg-1" data-aos="fade-up" data-aos-delay="100">
          <h2 class="content-title mb-4">Harit Eco Ventures Environmental Conservation Company</h2>
          <p class="mb-4">
  ...
  <section id="services" class="services section">
    <div class="container section-title" data-aos="fade-up">
      <h2>Recycle waste</h2>
      <p>What types waste do we buy</p>
        ...
        <div class="row g-0">
          <div class="col-lg-3 col-md-6">
            <div class="service-item">
              ...
              <div class="service-item-content">
                <h3 class="service-heading">Plastic waste</h3>
                <p>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="service-item">
              ...
              <div class="service-item-content">
                <h3 class="service-heading">Paper waste</h3>
                <p>
                  Gravida sodales condimentum pellen tesq accumsan orci quam
                  sagittis sapie
                </p>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="service-item">
              ...
              <div class="service-item-content">
                <h3 class="service-heading">Glass Materials</h3>
                <p>
                  Gravida sodales condimentum pellen tesq accumsan orci quam
                  sagittis sapie
                </p>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="service-item">
              ...
              <div class="service-item-content">
                <h3 class="service-heading">Metal waste</h3>
                <p>
                  Gravida sodales condimentum pellen tesq accumsan orci quam
                  sagittis sapie
                </p>
              ...
              <div class="service-item">
                <div class="service-item-contents">
                  <a href="#">
                    ...
                    <h2 class="service-item-title">Recycling</h2>
                  </a>
                </div>
                <img src="assets/img/img_sq_1.jpg" alt="Image" class="img-fluid">
              </div>
            ...
            <div class="swiper-slide">
              <div class="service-item">
                <div class="service-item-contents">
                  <a href="#">
                    <span class="service-item-category">We do</span>
                    <h2 class="service-item-title">Waste Collecting</h2>
                  </a>
                </div>
            ...
            <div class="swiper-slide">
              <div class="service-item">
                <div class="service-item-contents">
                  <a href="#">
                    <span class="service-item-category">We do</span>
                    <h2 class="service-item-title">Awareness program</h2>
                  </a>
                </div>
